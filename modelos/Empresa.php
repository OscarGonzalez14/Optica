...
public function get_pacientes(){
 ...
 public function editar_paciente($codigo,$nombres,$telefono,$edad,$ocupacion,$empresa,$correo,$id_paciente){
      ...
      parent::set_names();
        ...
        public function get_datos_paciente($telefono,$correo){

           $conectar=parent::conexion();

           $sql= "select * from pacientes where telefono=? or correo=?";
