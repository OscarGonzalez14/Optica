<div class="modal fade" id="agregarAccesorio" role="dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" align="center"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> AGREGRAR ACCESORIOS</h4>
        </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-10">
        ...
        <input class="form-control" id="modelo" name="modelo" type="text" placeholder="Descripcion del Accesorio" required>
      </div>
      <div class="col-xs-2">
    ...
    <input type="hidden" name="categoria" id="categoria" value="accesorios" />
